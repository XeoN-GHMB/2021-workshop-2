...
ul.randomlist li:nth-child(1) {
    background-color: #b69a64;
    width: 100%
}

ul.randomlist li:nth-child(2) {
    background-color: #a7a7a7;
    width: 90%
}

ul.randomlist li:nth-child(3) {
    background-color: #a46645;
    width: 80%
}


ul.randomlist-tschau {
    margin: 0;
    padding: 0;
    margin-bottom: 30px
}

ul.randomlist-tschau li {
    list-style: none;
    padding: 3px 10px;
    border-radius: 4px;
    margin-bottom: 5px;
...
body, input, select, textarea,#app {
    color: #ffffff;
...
ul.random_umfrage_list {
    margin: 0;
    padding: 0;
    text-decoration: none;
}

ul.random_umfrage_list li {
    margin: 0;
    padding: 0;
    text-decoration: none;
    width: 23%;
...
ul.random_umfrage_list li:hover {
    background-color: #000000;
}


ul.random_umfrage_list li a {
    width: 100%;
    display: inline-block;
    text-decoration: none;
